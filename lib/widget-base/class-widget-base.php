		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php _e( 'Upload', 'mediclean' ); ?>" data-uploader_title="<?php _e( 'Select Image', 'mediclean' ); ?>" data-uploader_button_text="<?php _e( 'Choose Image', 'mediclean' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo _x( 'X', 'Remove Button', 'mediclean' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
