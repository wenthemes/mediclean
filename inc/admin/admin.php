	...
	<div class="wrap about-wrap">
		...
		<div class="two-col">
			...
			<div class="col about-text">
				...
				<p><?php _e( 'Version', 'mediclean' ); ?>:&nbsp;<?php echo $theme->display( 'Version' ); ?></p>
			</div><!-- .col -->
		...
		<div class="four-col">
			...
			<div class="col">
				...
				<p>
					<a class="button button-primary" href="<?php echo esc_url( 'http://themepalace.com/downloads/mediclean-pro/' ); ?>" target="_blank"><?php esc_html_e( 'Buy Pro', 'mediclean' ); ?></a>
				</p>
			...
			<div class="col">
				...
				<p>
					<a class="button button-primary" href="<?php echo esc_url( 'http://themepalace.com/theme-instructions/mediclean/' ); ?>" target="_blank"><?php esc_html_e( 'Documentation', 'mediclean' ); ?></a>
				</p>
			...
			<div class="col">
				...
				<p>
					<a class="button button-primary" href="<?php echo esc_url( 'http://themepalace.com/forum/mediclean/' ); ?>" target="_blank"><?php esc_html_e( 'Get Support', 'mediclean' ); ?></a>
				</p>
...
function mediclean_load_admin_scripts( $hook ) {
	...
	if ( 'appearance_page_mediclean' === $hook ) {
		...
		wp_enqueue_style( 'mediclean-admin', get_template_directory_uri() . '/css/admin' . $min . '.css', false, '1.0.0' );
