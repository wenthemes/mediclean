									...
									<div class="latest-news-text-content">
										...
										<?php if ( 1 === $cnt ) : ?>
											<div class="latest-news-summary">
												<?php echo wpautop( mediclean_the_excerpt( esc_attr( $params['excerpt_length'] ), $post ) ); ?>
	...
	class Mediclean_Call_To_Action_Widget extends Mediclean_Widget_Base {
		...
		function __construct() {
			...
			$fields = array(
				...
				'description' => array(
					'label' => __( 'Description:', 'mediclean' ),
					'type'  => 'textarea',
					'class' => 'widefat',
					),
				'primary_button_text' => array(
					'label'   => __( 'Primary Button Text:', 'mediclean' ),
					'default' => __( 'Learn more', 'mediclean' ),
					'type'    => 'text',
					'class'   => 'widefat',
					),
				'primary_button_url' => array(
					'label' => __( 'Primary Button URL:', 'mediclean' ),
					'type'  => 'url',
					'class' => 'widefat',
					),
				);
